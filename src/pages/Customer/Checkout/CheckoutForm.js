...
export default function CheckoutForm() {
    ...
    useEffect(() => {
        ...
        Axios.get(process.env.REACT_APP_API_URL + "/api/getCart?email=" + localStorage.getItem("customerEmail")).then((res) => {
    ...
    const submitPurchase = (data) => {
        Axios.post("https://blitz.cs.niu.edu/creditcard", {
            ...
            if(response.data.errors){
                ...
                Axios.post(process.env.REACT_APP_API_URL + "/api/updateOrder", {
