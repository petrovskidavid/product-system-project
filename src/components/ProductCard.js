...
export default function ProductCard(props) {
    ...
    // Handle the forms input and provides parameters to use
    ...
    if(location.pathname === "/store"){
        ...
        const updateQuantity = () => {
            Axios.post(process.env.REACT_APP_API_URL + "/api/updateProductQuantity", {
                productID: props.productID,
            ...
            <div className="product-card">
                ...
                <div>
                    <form onSubmit={handleSubmit(updateQuantity)}>
                        ...
                        {selectedQuantity === 0 ? 
                            <button className="product-card-button" disabled>Add Quantity</button> :
                            <input type="submit" className="product-card-button" value="Add Quantity" required />
                        }
                    </form>
                </div>
